    ...
    return (
        <div>
            ...
            <div className='my-16 md:my-20 md:w-10/12 w-11/12 mx-auto'>
                <div className="container mx-auto lg:flex lg:flex-row items-center p-16 rounded-3xl  shadow-2xl">
                    <div className="md:w-1/2">
                        <h1 className='text-3xl mb-8'>Welcome to <span className='text-orange-500 font-bold italic'>DELIZIOSO</span></h1>
                    ...
                    <div className="md:w-1/2 ">
                        <div className="card flex-shrink-0 w-full">
                            ...
                            <div>
                                <p className='text-sm'>New to <span className='font-semibold text-orange-500'>DELIZIOSO</span> ?<Link to="/registration"><button className="btn btn-active btn-link normal-case text-sm text-sky-700 ">Sign Up Here</button>
                                </Link></p>
                            </div>
                                </div>
                            </div>
