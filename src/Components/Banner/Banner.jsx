...
const Banner = () => {
  ...
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="text-center">
      <h1 className="md:w-9/12 mx-auto text-2xl md:text-5xl text-white font-bold leading-tight mb-4 line-">Buon Appetito! Experience Authentic <span className='text-orange-500 italic text-3xl md:text-6xl'>Italian</span> Cuisine </h1>
      <p className="text-sm md:text-xl text-white mb-8 md:w-8/12 w-10/12 mx-auto">Our chefs use only the freshest ingredients and traditional cooking techniques to create mouthwatering dishes that are sure to satisfy.</p>
